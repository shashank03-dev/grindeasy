  ...
  return (
    <main className="mx-auto w-full max-w-4xl px-6 py-16">
      <header className="mb-12">
        <h1 className="font-mono text-sm font-medium tracking-wide text-primary">viberank</h1>
  ...
  return (
    <div className="rounded-lg border border-dashed border-border px-6 py-16 text-center">
      ...
      <p className="mx-auto mt-2 max-w-[52ch] text-sm text-muted-foreground">
        Run <code className="font-mono text-foreground">npx viberank</code> in a terminal, then{" "}
        <code className="font-mono text-foreground">viberank login</code> to claim the first place
        on this board.
      </p>
    </div>
  );
