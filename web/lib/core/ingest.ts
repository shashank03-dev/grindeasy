 ...
 *
 * Each baseline belongs to exactly one *device* token. Sharing one baseline
 * across two machines makes their differing totals ratchet against each other
 * and credits elapsed wall-clock time for no work — see the design doc.
 */
